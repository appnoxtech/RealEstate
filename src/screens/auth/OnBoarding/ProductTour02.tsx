    ...
    <SafeAreaView>
      <View style={styles.container}>
        ...
        <Text style={styles.containerText}>
          ...
          <Text style={styles.containerTextInner}>in just one click</Text>{' '}
        </Text>
        ...
        <View>
          <ImageBackground
            ...
            <View style={styles.backGroundImageButton}>
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('ProductTour03' as never)}
                style={styles.button}>
